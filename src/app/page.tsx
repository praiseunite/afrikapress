    ...
    <div className="relative min-h-[calc(100vh-64px)] overflow-hidden bg-black text-white">
      ...
      <main className="relative z-10 flex min-h-[calc(100vh-64px)] w-full flex-col justify-center px-8 py-16 lg:px-16 xl:px-24">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="animate-fade-in-up text-5xl font-extrabold leading-tight tracking-tight text-white sm:text-6xl lg:text-7xl text-center sm:text-left" style={{ animationDelay: "100ms" }}>
            Speak Your Truth.<br />
            <span className="text-emerald-500">Nobody Can Stop You.</span>
          </h1>

          <p className="animate-fade-in-up mt-6 max-w-2xl text-lg text-zinc-300 sm:text-xl leading-relaxed text-center sm:text-left mx-auto sm:mx-0" style={{ animationDelay: "200ms" }}>
          ...
          <div className="animate-fade-in-up mt-10 flex flex-col gap-4 sm:flex-row justify-center sm:justify-start" style={{ animationDelay: "300ms" }}>
            <Link
              href="/auth/create"
            ...
            <Link
              href="/feed"
              className="inline-flex items-center justify-center rounded-xl bg-zinc-900/80 px-8 py-4 font-bold text-white backdrop-blur transition-colors hover:bg-zinc-800"
            >
              Read the News
            </Link>
          </div>
          ...
          <div className="animate-fade-in-up mt-16 grid grid-cols-1 gap-8 border-t border-white/20 pt-12 sm:grid-cols-3 text-center sm:text-left" style={{ animationDelay: "400ms" }}>
            <div>
